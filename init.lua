...
-- Disable netrwPlugin in favour of custom dashboard
...
-- Disable folding on buffer enter
...
-- Use J and K to move visual block up and down
...
-- Start Alpha dashboard after plugins are loaded
vim.cmd [[:Alpha]]
